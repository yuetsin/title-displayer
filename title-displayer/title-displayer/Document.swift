...
class Document: NSDocument {
    ...
    override func makeWindowControllers() {
        ...
        let storyboard = NSStoryboard(name: MainStoryboardIdentifiers.name, bundle: nil)
        let windowController = storyboard.instantiateController(withIdentifier: MainStoryboardIdentifiers.documentWindow) as! MainWindowController
